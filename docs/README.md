# Neste desafio foi utilizado a conexão singleton onde por meio de uma varivavel de instancia, fazemos toda manipulação quando o banco de dados foi instaciado ou não. 
